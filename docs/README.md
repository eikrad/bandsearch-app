...
| [adr/README.md](adr/README.md) | ADR index — how to add a new decision record |
...
| [maintenance.md](maintenance.md) | Maintenance log — periodic dependency and health checks |
...
| [superpowers/specs/2026-06-13-stop-retry-buttons-design.md](superpowers/specs/2026-06-13-stop-retry-buttons-design.md) | Stop / retry buttons design spec for the chat UI |
