...
| [architecture/2026-06-03-auto-update-plan.md](architecture/2026-06-03-auto-update-plan.md) | Auto-update plan — Tauri updater integration and release pipeline (**planned, not yet implemented** — see `docs/ROADMAP.md`) |
...
| [agents/domain.md](agents/domain.md) | *(AI agent tooling, not product docs)* Domain knowledge for AI coding agents working in this repo |
| [agents/issue-tracker.md](agents/issue-tracker.md) | *(AI agent tooling, not product docs)* Issue tracking conventions |
| [agents/triage-labels.md](agents/triage-labels.md) | *(AI agent tooling, not product docs)* Triage label definitions |
