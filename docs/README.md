...
- **Maintaining dependencies?** See [maintenance.md](maintenance.md) for upgrade notes and periodic tasks.

## Historical planning docs

The `architecture/` folder contains dated implementation plans from earlier development phases. These are reference material, not actively maintained.
