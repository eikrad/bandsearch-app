...
- [x] Step 5: LLM-as-judge worker — async LLM-as-judge scoring each band on relevance, obscurity fit, evidence quality, and discovery value; activated by `MISTRAL_API_KEY`; silently skipped if absent ✓ Done
